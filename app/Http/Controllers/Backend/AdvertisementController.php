...
class AdvertisementController extends Controller
{
    ...
    public function homepageBanerSectionOne(Request $request)
    {
        $request->validate([
            'banner_image' => ['image'],
            'banner_url'   => ['required']
    ...
    public function homepageBanerSectionTwo(Request $request)
    {
        $request->validate([
    ...
    public function homepageBanerSectionThree(Request $request)
    {
        $request->validate([
            'banner_one_image' => ['image'],
            'banner_one_url'   => ['required'],
    ...
    public function homepageBanerSectionFour(Request $request)
    {
        $request->validate([
            'banner_image' => ['image'],
            'banner_url'   => ['required']
